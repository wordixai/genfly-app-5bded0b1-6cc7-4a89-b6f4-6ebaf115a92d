export default function TestimonialSection() {
  return (
    <section className="relative z-10 py-8 md:py-16">
      <div className="absolute left-1/2 top-0 -z-10 w-full -translate-x-1/2 h-[200px] md:h-[400px] rounded-[100%] bg-upstash-green opacity-10 blur-[60px] md:blur-[90px] pointer-events-none"></div>
      ...
      <div className="mx-auto max-w-screen-xl px-6 md:px-10">
        <div className="mt-16 grid grid-cols-3 gap-2 rounded-2xl text-black md:mt-24 md:grid-cols-6 md:gap-6 dark:text-white">
          <div className="group flex flex-col overflow-hidden px-4 rounded-2xl md:rounded-4xl dark:bg-gray-800 dark:hover:bg-white col-span-3 bg-white py-8 shadow-sm transition-colors sm:px-16 sm:py-10">
            <span className="flex h-10 items-center justify-center text-gray-700 transition-colors group-hover:text-upstash-green group-hover:opacity-100 dark:text-white dark:opacity-80">
            ...
            <p className="mt-4 grow md:text-xl text-gray-600 dark:text-gray-300 transition-colors dark:group-hover:text-gray-800">
